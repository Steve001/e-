...
//		request.getRequestDispatcher("mainAdmin.jsp").forward(request, response);
	...
	private String genPagation(int totalNum, int currentPage, int pageSize){
		...
		pageCode.append("<li><a href='assessList?page=1'>首页</a></li>");
		if(currentPage==1) {
			pageCode.append("<li class='disabled'><a href='#'>上一页</a></li>");
		}else {
			pageCode.append("<li><a href='assessList?page="+(currentPage-1)+"'>上一页</a></li>");
		}
		for(int i=currentPage-2;i<=currentPage+2;i++) {
			...
			if(i==currentPage) {
				...
				pageCode.append("<li><a href='assessList?page="+i+"'>"+i+"</a></li>");
			}
		}
		if(currentPage==totalPage) {
			pageCode.append("<li class='disabled'><a href='#'>下一页</a></li>");
		} else {
			pageCode.append("<li><a href='assessList?page="+(currentPage+1)+"'>下一页</a></li>");
		}
		pageCode.append("<li><a href='assessList?page="+totalPage+"'>尾页</a></li>");
